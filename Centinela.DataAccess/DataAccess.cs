...
namespace Centinela.DataAccess
{
    public class DataAccess
    {
        ...
        public static String Conexion(string Base)
        {
            string Server = ManagerConfig.GetKeyConfigString(Base + "_SERVER");
            string DataBase = ManagerConfig.GetKeyConfigString(Base + "_BD");
            string Usuario = ManagerConfig.GetKeyConfigString(Base + "_USUARIO");
            string Password = ManagerConfig.GetKeyConfigString(Base + "_PASSWORD");
            Password = SegCrypt.EncryptDecrypt(false, Password);
    ...
    public class Transaccion
    {
        ...
        private readonly System.Collections.Generic.List<StoreProcedure> Lote = new List<StoreProcedure>();
        /// <summary>
